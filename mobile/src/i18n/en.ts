...
const en: Record<TranslationKey, string> = {
  ...
  'settings.pairingHint': 'Connect to server (pairing code required in remote mode)',
  ...
  'pair.hint': 'On the server: Settings → Security → Generate pairing code,\nthen enter the 6-digit code here',
  'pair.enterCode': 'Enter the 6-digit pairing code',
  ...
  'pair.invalid': 'Pairing code incorrect or expired',
  'pair.pair': 'Pair',
