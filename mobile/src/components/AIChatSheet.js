...
function Bubble({ msg }) {
  ...
  const mdStyles = useMemo(() => ({
    ...
    heading1: { fontSize: 18, fontWeight: '700', marginTop: 6, marginBottom: 3 },
    heading2: { fontSize: 16, fontWeight: '600', marginTop: 5, marginBottom: 3 },
    heading3: { fontSize: 15, fontWeight: '600', marginTop: 4, marginBottom: 2 },
    code_inline: {
    ...
    >
      <BottomSheetView style={{ flex: 1 }}>
        ...
        <View style={[styles.header, { borderBottomColor: theme.colors.outline + '30' }]}>
          <Text style={{ fontWeight: '600', color: theme.colors.primary, flex: 1 }}>AI 助手</Text>
