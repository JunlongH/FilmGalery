...
const _e_mergeLines = _sharedExports.mergeLines;
export { _e_mergeLines as mergeLines };
const _e_classifyLines = _sharedExports.classifyLines;
export { _e_classifyLines as classifyLines };
const _e_parallelLineDistance = _sharedExports.parallelLineDistance;
export { _e_parallelLineDistance as parallelLineDistance };
const _e_getLineEndpoints = _sharedExports.getLineEndpoints;
export { _e_getLineEndpoints as getLineEndpoints };
