...
export { CAMERA_TYPES, FILM_FORMATS, LENS_MOUNTS, SCANNER_TYPES, FLASH_TYPES, FILM_BACK_SUB_FORMATS, FILM_BACK_MOUNTS, FILM_CATEGORIES, FILM_PROCESSES, FOCUS_TYPES, CONDITIONS, STATUSES, METER_TYPES, SHUTTER_TYPES };