...
const _e_detect = _sharedExports.detect;
export { _e_detect as detect };
const _e_sobelGradient = _sharedExports.sobelGradient;
export { _e_sobelGradient as sobelGradient };
const _e_nonMaxSuppression = _sharedExports.nonMaxSuppression;
export { _e_nonMaxSuppression as nonMaxSuppression };
const _e_hysteresisThreshold = _sharedExports.hysteresisThreshold;
export { _e_hysteresisThreshold as hysteresisThreshold };
const _e_getEdgePoints = _sharedExports.getEdgePoints;
export { _e_getEdgePoints as getEdgePoints };
