...
const en: Record<TranslationKey, string> = {
  ...
  // Digital mode
  'digital.enabledTitle': 'Digital mode is on',
  'digital.enabledBody': 'Browse your digital photos and albums in the Library.',
  'digital.goToDigital': 'Go to digital library',
  ...
  'digital.albumsCount': '{count} albums',
  ...
  'digital.albumName': 'Album name',
  'digital.albumNamePlaceholder': 'Enter album name',
  'digital.parentAlbumOptional': 'Parent album (optional)',
  'digital.parentNone': 'None (top-level)',
  'digital.create': 'Create',
  'digital.albumCreated': 'Album created',
  'digital.createAlbumFailed': 'Failed to create album',
  'digital.photoActions': 'Photo actions',
  'digital.addToAlbum': 'Add to other album',
  'digital.removeFromAlbum': 'Remove from this album',
  'digital.setCover': 'Set as album cover',
  'digital.chooseAlbum': 'Choose album',
  'digital.noAlbumsToPick': 'No albums to choose',
  'digital.addedToAlbum': 'Added to album',
  'digital.removedFromAlbum': 'Removed from album',
  'digital.coverSet': 'Cover updated',
  ...
  'digital.photoView.deletePhoto': 'Delete photo',
  'digital.photoView.deleteConfirmTitle': 'Delete photo?',
  'digital.photoView.deleteConfirmBody': 'It will be moved to trash and can be restored from the desktop app.',
  'digital.photoView.movedToTrash': 'Moved to trash (restorable from desktop)',
  'digital.photoView.addedToAlbum': 'Added to album "{name}"',
  'digital.photoView.viewExif': 'View full EXIF',
  'digital.albumsInTitle': 'In albums',

  // EXIF sheet (M2-C)
  'digital.exif.title': 'EXIF Details',
  'digital.exif.camera': 'Camera',
  'digital.exif.lens': 'Lens',
  'digital.exif.focalLength': 'Focal length',
  'digital.exif.aperture': 'Aperture',
  'digital.exif.shutter': 'Shutter',
