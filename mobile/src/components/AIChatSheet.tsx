...
const TOOL_LABELS_EN: Record<string, string> = {
  ...
  get_photo_neighbors:     'Find neighbor photos',
  update_photo_metadata:   'Update photo metadata',
  batch_update_photos:     'Batch update photos',
  set_photo_rating:        'Set photo rating',
  toggle_photo_favorite:   'Toggle favorite',
  delete_photo:            'Delete photo',
  list_rolls:              'List rolls',
  get_roll_detail:         'View roll details',
  update_roll:             'Update roll',
  set_roll_cover:          'Set roll cover',
  set_roll_preset:         'Apply preset',
  get_film_info:           'Look up film info',
  list_film_items:         'List film stock',
  update_inventory_item:   'Update inventory item',
  record_film_purchase:    'Record purchase',
  ...
  get_shot_log:            'View shot log',
  update_shot_log:         'Update shot log',
  add_shot_log_entry:      'Add shot log entry',
  get_stats:               'Read statistics',
  analyze_shooting_patterns: 'Analyze shooting patterns',
  cost_analysis:           'Cost analysis',
  equipment_usage_stats:   'Equipment usage stats',
  get_render_params:       'View render params',
  suggest_render_params:   'Suggest render params',
  batch_apply_preset:      'Batch apply preset',
};
